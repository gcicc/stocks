"""
Fix parser for multi-section CSV format with account summary and positions sections.
"""
...
def create_multi_section_parser():
    """Create parser for multi-section CSV with account summary and positions."""
...
'''
    ...
    # Write the multi-section parser
    parser_file = os.path.join(src_dir, 'portfolio', 'csv_parser.py')
    with open(parser_file, 'w', encoding='utf-8') as f:
        f.write(parser_code)
    
    print("SUCCESS: Multi-section CSV parser deployed!")
    print("HANDLES: Account summary sections + position data")
    print("FEATURES: Section detection, inconsistent column handling")
    print("SYMBOLS: Extracts DOW, ISRG, KHC, etc. (excludes CASH, TOTAL)")
    print("RESTART: Please restart Streamlit to use new parser")


if __name__ == "__main__":
    create_multi_section_parser()